...
contract FlightSuretyApp {
    ...
    // refernce data contract address
    FlightSuretyData private flightSuretyDataContract;


    //  airline polls no. has received for registration
    ...
    */
    modifier requireIsTimestampValid(uint timestamp)
    {
        ...
        require(blockTime <= timestamp, "Error, Timestamp should be in future");
        _;
    }
    ...
    */
    ...
    {
      require(isAirlineRegistered(airline), "Error, Airline is not registered");
      _;
    }

    /**
    * @dev checking  if  the airline has deposited sufficient funds
    */
    modifier requireCallerAirlineHasSufficientFunds()
    {
        uint funds = getAirlineFunds(msg.sender);
        require(funds >= MIN_AIRLINES_FUND_REQUIRED, "Error, Insufficient funds deposited by airline");
        _;
    }
    ...
    */
    ...
    /**
    * @dev checking if an airline has voted for an airline
    */
    ...
    internal
    {
      ...
      /**
    * @dev function to get fund for specific airline
    */
    ...
    */   
                            ...
                            returns(bool success, uint256 votes)
    {
        ...
        if(numberOfAirlinesRegistered < MIN_AIRLINES_FOR_CONSENSUS) {
            ...
            // checking  if duplicate call for vote
